...
export default async function CustomerMessagesPage() {
  ...
  // Fetch all bookings with messages for this customer
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-zinc-400 mt-1">Chat with your service providers</p>
      </div>
      <BookingInbox threads={threads} role="customer" />
    </div>
  )
}
