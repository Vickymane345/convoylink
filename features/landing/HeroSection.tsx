    ...
    <section ref={ref} className="relative min-h-[100svh] flex items-center justify-center overflow-hidden">
      ...
      <motion.div style={{ y: yBg }} className="absolute inset-0 will-change-transform">
        ...
        <div className="absolute inset-0" style={{
          background: `
            radial-gradient(ellipse 90% 55% at 50% -5%, rgba(249,115,22,0.18) 0%, transparent 65%),
        ...
        {/* Vignette */}
        <div className="absolute inset-0" style={{
          background: 'radial-gradient(ellipse 120% 120% at 50% 50%, transparent 40%, rgba(9,9,11,0.75) 100%)'
        }} />
        {/* Bottom fade */}
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <motion.p
            ...
            className="text-base sm:text-xl text-zinc-300 max-w-2xl leading-relaxed mb-10 px-2"
          >
